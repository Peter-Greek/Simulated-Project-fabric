...
public class ZiplineClientManager implements InteractCallback {
    ...
    public static void tick() {
        ...
        final double maxRange = SimReach.blockInteractionRange(mc.player) + 1;
    ...
    private static void ridingTick() {
        ...
        final double reach = SimReach.blockInteractionRange(mc.player) + 1;
    ...
    public static boolean canStartRidingDistance(final ClosestQuery query, final Player player) {
        final double reach = SimReach.blockInteractionRange(player) + 1;
