...
public class SimLang {
    ...
    /**
     * Strings this port needs that upstream has no equivalent for. They go here
     * rather than into {@code datagen/lang/en_us.json}, which is upstream's
     * Crowdin source and is not ours to edit; a line removed from here when its
     * feature lands is a line that does not have to be untangled from upstream's
     * file later.
     */
    private static void portOnlyLang(final BiConsumer<String, String> consumer) {
        consumer.accept("simulated.gui.assembly.exception.noPhysicsEngine",
                "Cannot assemble: the physics engine is not available in this build!");
    }
