...
public class MagnetPair<T extends BlockEntity & SimMagnet> {
    ...
    public void applyForces(final double timeStep, final T magnet1, final T magnet2) {
        ...
        if (this.canConnect(this.relativePosition, this.moment1, this.moment2)) {
            ...
            final SubLevelPhysicsSystem physicsSystem = ServerSubLevelContainer.getContainer((ServerLevel) this.level).physicsSystem();
            ...
            if (subLevel1 != null) {
                ...
                final QueuedForceGroup forceTotal1 = subLevel1.getOrCreateQueuedForceGroup(ForceGroups.MAGNETIC_FORCE);
            ...
            if (subLevel2 != null) {
                ...
                final QueuedForceGroup forceTotal2 = subLevel2.getOrCreateQueuedForceGroup(ForceGroups.MAGNETIC_FORCE);
