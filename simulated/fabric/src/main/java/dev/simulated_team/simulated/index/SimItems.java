...
public class SimItems {
    ...
    public static final ItemEntry<SpringItem> SPRING =
            REGISTRATE.item("spring", SpringItem::new)
                    // Upstream sets a default bounciness component on the stack.
                    // 1.20.1 has no default components; the item reads its own
                    // default through SimDataComponents instead.
                    .recipe((ctx, prov) ->
