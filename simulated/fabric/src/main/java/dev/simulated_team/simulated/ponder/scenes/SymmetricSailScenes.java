...
public class SymmetricSailScenes {
    public static void symmetricSailMain(final SceneBuilder builder, final SceneBuildingUtil util) {
        ...
        final int thrustArrowColor = ForceGroups.PROPULSION.color();
        ...
        final int liftArrowColor = ForceGroups.LIFT.color();
        ...
        final int gravityArrowColor = ForceGroups.GRAVITY.color();
