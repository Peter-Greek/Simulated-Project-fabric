...
public class KineticStatsMixin {
	...
	@WrapOperation(method = "getKineticStats", at = @At(value = "INVOKE", target = "Lnet/createmod/catnip/lang/LangBuilder;add(Lnet/createmod/catnip/lang/LangBuilder;)Lnet/createmod/catnip/lang/LangBuilder;", ordinal = 0))
	...
	@WrapOperation(method = "getKineticStats", at = @At(value = "INVOKE", target = "Lnet/createmod/catnip/lang/LangBuilder;add(Lnet/createmod/catnip/lang/LangBuilder;)Lnet/createmod/catnip/lang/LangBuilder;", ordinal = 2))
	...
	@WrapOperation(method = "getKineticStats", at = @At(value = "INVOKE", target = "Lnet/createmod/catnip/lang/LangBuilder;translate(Ljava/lang/String;[Ljava/lang/Object;)Lnet/createmod/catnip/lang/LangBuilder;", ordinal = 0))
