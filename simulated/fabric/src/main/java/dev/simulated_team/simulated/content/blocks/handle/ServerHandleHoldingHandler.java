...
public class ServerHandleHoldingHandler {
	...
	public static void sync() {
		final net.minecraft.server.MinecraftServer server =
				net.fabricmc.loader.api.FabricLoader.getInstance().getGameInstance() instanceof
						final net.minecraft.server.MinecraftServer running ? running : null;
		VeilPacketManager.all(server)
				.sendPacket(new ClientboundPlayersHoldingHandlePacket(holdingPlayers.keySet()));
	}
}
