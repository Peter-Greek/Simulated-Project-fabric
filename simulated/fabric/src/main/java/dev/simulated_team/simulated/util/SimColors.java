...
public class SimColors {
    ...
    public static Color fromOklab(final float lightness, final float a, final float b) {
        ...
        return new Color(
                Mth.clamp(+4.0767416621f * l - 3.3077115913f * m + 0.2309699292f * s, 0f, 1f),
                Mth.clamp(-1.2684380046f * l + 2.6097574011f * m - 0.3413193965f * s, 0f, 1f),
                Mth.clamp(-0.0041960863f * l - 0.7034186147f * m + 1.7076147010f * s, 0f, 1f)
        );
    }
