...
public class ClientRopeItemHandler {
    ...
    public static void tick() {
        ...
        for (final InteractionHand hand : InteractionHand.values()) {
            ...
            if (!SimComponents.has(heldItem, SimDataComponents.ROPE_FIRST_CONNECTION))
                continue;

            final BlockPos firstBlock = SimComponents.get(heldItem, SimDataComponents.ROPE_FIRST_CONNECTION);
