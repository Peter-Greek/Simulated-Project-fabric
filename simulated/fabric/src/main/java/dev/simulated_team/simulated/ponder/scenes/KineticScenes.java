...
public class KineticScenes {
    ...
    public static void steeringWheelComparator(final SceneBuilder builder, final SceneBuildingUtil util) {
        ...
        final ElementLink<ParrotElement> birb = scene.special().createBirb(steeringWheelPos.north().getCenter().subtract(0, 0.5, 0).subtract(0, 2, 0.25), ParrotPose.FacePointOfInterestPose::new);
