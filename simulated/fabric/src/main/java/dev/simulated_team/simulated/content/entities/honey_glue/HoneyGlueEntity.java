...
public class HoneyGlueEntity extends Entity implements SpecialEntityItemRequirement {
    ...
    public void setBounds(final AABB bounds) {
        ...
        this.blockMin = BlockPos.containing(new Vec3(bounds.minX, bounds.minY, bounds.minZ));
        this.blockMax = BlockPos.containing(new Vec3(bounds.maxX, bounds.maxY, bounds.maxZ));
    }
