...
import dev.simulated_team.simulated.backport.physics.api.math.OrientedBoundingBox3d;
...
public class MergingGlueRenderer extends SmartBlockEntityRenderer<MergingGlueBlockEntity> {
    ...
    private static void renderGlueCross(final Vector3dc posA,
        ...
        addVertex(buffer, pose, posA.fma(-0.5, upA, vertex)).color(0xffffffff).uv(0.0f, 0.0f).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(light).normal(ms.last().normal(), 0.0f, 1.0f, 0.0f);
        addVertex(buffer, pose, posA.fma(0.5, upA, vertex)).color(0xffffffff).uv(0.0f, 1.0f).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(light).normal(ms.last().normal(), 0.0f, 1.0f, 0.0f);
        addVertex(buffer, pose, posB.fma(0.5, upB, vertex)).color(0xffffffff).uv(1.0f, 1.0f).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(light).normal(ms.last().normal(), 0.0f, 1.0f, 0.0f);
        addVertex(buffer, pose, posB.fma(-0.5, upB, vertex)).color(0xffffffff).uv(1.0f, 0.0f).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(light).normal(ms.last().normal(), 0.0f, 1.0f, 0.0f);
        ...
        addVertex(buffer, pose, posA.fma(-0.5, rightA, vertex)).color(0xffffffff).uv(0.0f, 0.0f).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(light).normal(ms.last().normal(), 0.0f, 1.0f, 0.0f);
        addVertex(buffer, pose, posA.fma(0.5, rightA, vertex)).color(0xffffffff).uv(0.0f, 1.0f).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(light).normal(ms.last().normal(), 0.0f, 1.0f, 0.0f);
        addVertex(buffer, pose, posB.fma(0.5, rightB, vertex)).color(0xffffffff).uv(1.0f, 1.0f).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(light).normal(ms.last().normal(), 0.0f, 1.0f, 0.0f);
        addVertex(buffer, pose, posB.fma(-0.5, rightB, vertex)).color(0xffffffff).uv(1.0f, 0.0f).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(light).normal(ms.last().normal(), 0.0f, 1.0f, 0.0f);
